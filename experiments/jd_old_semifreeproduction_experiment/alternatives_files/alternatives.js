...
var nTargets = 10;//shuffle([9,10])[0];//,9,10])[0];
//console.log(nTargets);
var alternatives = ["all","half","few","several","some","most","many","eight","nine","ten"];//["all","half","few","several","some","most","many"];
//console.log(alternatives);
var numalts = {"-1":"zero", "0":"none", "1":"one", "2":"two", "3":"three", "4":"four", "5":"five", "6":"six", "7":"seven", "8":"eight", "9":"nine", "10":"ten", "11":"eleven"};
//console.log(numalts);
var acolors = [{color:"#0066FF",colorword:"blue"},{color:"#00CC00",colorword:"green"},{color:"#800080",colorword:"purple"},{color:"#000000",colorword:"black"},{color:"#808080",colorword:"gray"},{color:"#40E0D0",colorword:"turquoise"}];//shuffle([{color:"#0066FF",colorword:"blue"},{color:"#00CC00",colorword:"green"},{color:"#800080",colorword:"purple"},{color:"#000000",colorword:"black"},{color:"#808080",colorword:"gray"},{color:"#40E0D0",colorword:"turquoise"}]);//
...
var nSlides = 1+nTargets+1; // number of slides for progress bar
...
var numterms = [numalts[order[pcounter]],numalts[order[pcounter]-1],numalts[order[pcounter]+1]];
//console.log(numterms);
var utterances = alternatives;//shuffle(alternatives.concat(numterms));
var bowls = '<tr><td></td><td colspan="3"  class="utttd">very unlikely</td><td width="10"></td><td  colspan="3" class="utttdr">very likely</td></tr><tr><td colspan="2"></td><td width="3">|</td><td colspan="3"></td><td width="3">|</td><td></td></tr>';
    for (var i=0; i < utterances.length; i++) {    	
    	utt = utterances[i]; 
		bowls = bowls.concat('<tr><td align="left" class="utttd"><span class="utterance">'+utt+'</span></td><td colspan="2"></td><td colspan="3" width="110" align="center"><div id="q1slidy'+pcounter+i+'" align="center"></div></td><td colspan="2"></td></tr>');
    }     
    bowls = bowls.concat('<tr><td colspan="2"></td><td>|</td><td colspan="3"></td><td>|</td><td></td></tr><tr><td></td><td colspan="3" class="utttd">very unlikely</td><td></td><td colspan="3" class="utttdr">very likely</td></tr>');

    $(".utteranceOptions1").html(bowls);	
...
//		responses['target' + ind] = $("#"+caseLabel).slider("value");		
		if (responses[utterances[ind]] == null)
		{
			nResponses++;
		}
		responses[utterances[ind]] = $("#"+caseLabel).slider("value");				
    ...
    for (var i=0; i < utterances.length; i++) {                           
	     var caseLabel = "q1slidy" + pcounter + i;
         $("#"+caseLabel).slider({	
               animate: "fast",
