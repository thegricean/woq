...
// )  
  ...
  slides.objecttrial = slide({
    ...
    present_handle: function (stim) {
      ...
      if (this.stim.n_target === 0) {
        $(".question-body").text(" точка (не) е ")
      } else {
        $(".question-body").text(" точки са ")
      }
  ...
  slides.subj_info = slide({
    ...
    submit: function (e) {
      ...
      exp.data = {
        ...
        "experiment_id": "bulgarian-free-production-pilot",
        "author": "JI Xiang",
...
function init() {
  ...
  function makeStim(i, n) {
    ...
    var colors = ([{color: "#000000", colorword: "black", colorwordTargetLan: "черни"}, {color: "#FFFFFF", colorword: "white", colorwordTargetLan: "бели"}]);
