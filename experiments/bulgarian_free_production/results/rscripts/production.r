...
# setwd("d:/Dropbox/Tuebingen17SS/RA/woq/experiments/bulgarian_free_production/results")
setwd("~/Dropbox/Tuebingen17SS/RA/woq/experiments/bulgarian_free_production/results")
...
cairo_pdf("graphs/proportion_dist.pdf")
...
cairo_pdf("graphs/utterance_dist_bytotal.pdf",height=25,width=25)
...
cairo_pdf("graphs/utterance_dist.pdf",height=25,width=25)
...
cairo_pdf("graphs/utterance_dist_total.pdf",height=15,width=45)
ggplot(gathered, aes(x=Utterance)) +
  stat_count() +
...
cairo_pdf("graphs/top30.pdf",height=10,width=15)
