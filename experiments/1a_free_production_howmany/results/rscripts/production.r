...
setwd("/Users/titlis/cogsci/projects/stanford/projects/woq/experiments/1a_free_production_howmany/results")
...
ggplot(gathered, aes(x=Utterance)) +
  ...
  facet_wrap(~proportion_binned,scales="free_x") +
  theme(axis.text.x=element_text(angle=45,vjust=1,hjust=1))
ggsave("graphs/utterance_dist.pdf",height=25,width=35)
