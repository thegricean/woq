  ...
  slides.subj_info = slide({
    ...
    submit: function (e) {
      ...
      exp.data = {
        ...
        "experiment_id": "chinese-free-production-pilot",
        "author": "JI Xiang",
...
function init() {
  ...
  exp.completionURL = "https://www.prolific.ac/submissions/complete?cc=V2G39O2C";
  ...
  function makeStim(i, n) {
    ...
    var colors = ([{color: "#000000", colorword: "black", colorwordTargetLan: "黑色的"}, {color: "#FFFFFF", colorword: "white", colorwordTargetLan: "白色的"}]);
