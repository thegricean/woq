  ...
  slides.subj_info = slide({
    ...
    submit: function (e) {
      ...
      exp.data = {
        ...
        "experiment_id": "spanish-free-production-pilot",
        "author": "JI Xiang",
        "description": "Pilot experiment on Prolific collecting the most common Spanish quantifiers"
      };
...
function init() {
  ...
  function makeStim(i, n) {
    ...
    var colors = ([{color: "#000000", colorword: "black", colorwordTargetLan: "negro(s)"}, {color: "#FFFFFF", colorword: "white", colorwordTargetLan: "blanco(s)"}]);
